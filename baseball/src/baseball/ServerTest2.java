...
class SimpleChatServer {
	...
	/*
	 * public static void readConsoleInput(SimpleChatServer server) {// 내 생각엔
	 * 브로드캐스팅 BufferedReader br = new BufferedReader(new
	 * InputStreamReader(System.in)); try { while (true) { String message =
	 * br.readLine(); server.broadcastMessage(message); } } catch (IOException
	 * e) { e.printStackTrace(); } }
	 */
